...
{		
	...
	static void Environment::TraceVarible(Trace& trace, const wstring& key, const wstring& value, const wstring& description);
...
public:
	...
	static Environment CreateFormList(const list<wstring>& variables, const wstring& source, Trace& trace);
